                      ...
                      .map((item) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {!cartItem ? (
                              <button
                                className="w-28 h-8 absolute right-8 top-22 rounded-xl text-green-500 bg-white text-[14px] font-bold border border-gray-500"
                                onClick={() => dispatch(addItem(item))}
                              >
                                ADD
                              </button>
                            ) : (
                              <div className="w-28 h-8 absolute right-8 top-22 rounded-xl bg-white border border-gray-500 flex items-center justify-around text-green-500 font-bold">
                                <button
